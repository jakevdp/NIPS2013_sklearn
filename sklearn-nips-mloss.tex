...
popular algorithms in \sklearn. In particular, our objective is to illustrate
the use of \sklearn as a component of the larger scientific Python environment
